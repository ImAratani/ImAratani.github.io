...
function logAlelos() {
    const aleloA = document.getElementById('alleleA').value;
    const aleloa = document.getElementById('allelea').value;
    const aleloB = document.getElementById('alleleB').value;
    const alelob = document.getElementById('alleleb').value;
    const aleloC = document.getElementById('alleleC').value;
    const aleloc = document.getElementById('allelec').value;
    console.log(`Alelo A: ${aleloA}`);
    console.log(`Alelo a: ${aleloa}`);
    console.log(`Alelo B: ${aleloB}`);
    console.log(`Alelo b: ${alelob}`);
    console.log(`Alelo C: ${aleloC}`);
    console.log(`Alelo c: ${aleloc}`);
}

function calcularFenotipo() {
    var padre1_car1 = document.getElementById("caracteristica1_padre1").value;
    var padre1_car2 = document.getElementById("caracteristica2_padre1").value;
    var padre1_car3 = document.getElementById("caracteristica3_padre1").value;
    var padre2_car1 = document.getElementById("caracteristica1_padre2").value;
    ...
    var combinaciones_car1 = {
        "valor1_valor1": "100% Dominante",
        "valor1_valor2": "100% Dominante",
        "valor1_valor3": "50% Dominante, 50% Recesivo",
        "valor2_valor2": "75% Dominante, 25% Recesivo",
        "valor2_valor3": "50% Dominante, 50% Recesivo",
        "valor3_valor3": "100% Recesivo",
        "valor2_valor1": "100% Dominante",
        "valor3_valor1": "50% Dominante, 50% Recesivo",
        "valor3_valor2": "50% Dominante, 50% Recesivo",
    };
